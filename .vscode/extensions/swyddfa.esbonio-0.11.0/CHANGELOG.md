...
## Enhancements
  ...
  - The extension now gives the option for you to disable the language
...
## Misc
  ...
  - Renamed the `esbonio.server.entryPoint` configuration option to
...
## Fixes
  ...
  - Support syntax highligting for more header styles. Support
